...
while (true)
do
    for (( i=0; i<${#text_file}; i++ ))
    do
        #some_random_number=$RANDOM
        #floating_point_number=`bc <<< "scale=3; $some_random_number/1000000"`
        
        #echo $some_random_number
        #echo $floating_point_number

        printf "${text_file:$i:1}"

        #sleep $floating_point_number
        #sleep 0.5s
        usleep 200
        #sleep 1
    done
